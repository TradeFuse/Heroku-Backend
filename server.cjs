...
import("./brokerHandling/metatrader/createMetaTraderAccount.cjs")
  .then((module) => {
...
const discordBot = require("./modules/discordBot.cjs");
const createCustomer = require("./utils/stripe/createStripeCustomer.cjs");
const getCustomer = require("./utils/stripe/getStripeCustomer.cjs");
const deleteCustomer = require("./utils/stripe/deleteStripeCustomer.cjs");
const updateCustomer = require("./utils/stripe/updateStripeCustomer.cjs");
const initializeRobinhood = require("./brokerHandling/robinhood/initializeRobinhood.cjs");
const getRobinhoodOrders = require("./brokerHandling/robinhood/getRobinhoodOrders.cjs");
const getNewRobinhoodOrders = require("./brokerHandling/robinhood/getNewRobinhoodOrders.cjs");
const getOptionInstrumentRobinhood = require("./brokerHandling/robinhood/getOptionInstrument.cjs");
const getRobinhoodCryptoOrders = require("./brokerHandling/robinhood/getRobinhoodCryptoInstruments.cjs");
const getRobinhoodInstruments = require("./brokerHandling/robinhood/getInstrument.cjs");
const getOptionPositionRobinhood = require("./brokerHandling/robinhood/getOptionPosition.cjs");
const getAssetData = require("./utils/getAssetData.cjs");
const createSession = require("./utils/stripe/createStripeSession.cjs");
const createPortalSession = require("./utils/stripe/createPortalSession.cjs");
const getRiskFreeRate = require("./utils/getRiskFreeRate.cjs");
const handleOpenAIRequest = require("./utils/handleOpenAIRequests.cjs");
